...
红线4：触发词库查杀
出现以下禁用词，score直接封死在6分以下：眉头微皱、眼中闪过、几分、一丝、一抹、些许、隐约、缓缓、不禁、微微、轻轻、淡淡、嘴角勾起、心中一动、心头一震、心中暗道、不由得、不由自主、终于明白了、一切都变了、宛若、犹如、仿佛
不要改写建议。直接判刑。
...
严禁泛泛而谈。必须指出具体哪一段缺乏摩擦力，哪一段像机器人在汇报。
